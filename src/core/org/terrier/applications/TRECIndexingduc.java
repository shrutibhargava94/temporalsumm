 ...
 */
public class TRECIndexingduc {
	/** The logger used */
	private static Logger logger = Logger.getLogger(TRECIndexingduc.class);
	 ...
	 */
	public TRECIndexingduc(String _path, String _prefix)
	{
