...
class Copy_2_of_evaluation_allupdatestoruns
...
public static void readtrecmatches()
{
	...
	try {
		 run=new BufferedWriter(new FileWriter(new File("/home/bhargava/Documents/afghanistanfull/june4/runallupdates4topics.ssv")));
	} catch (IOException e1) {
		// TODO Auto-generated catch block
		e1.printStackTrace();
	...
	try {
		 updates=new BufferedWriter(new FileWriter(new File("/home/bhargava/Documents/afghanistanfull/june4/updatebulgariatop.tsv")));
	} catch (IOException e1) {
		// TODO Auto-generated catch block
		e1.printStackTrace();
	}*/
