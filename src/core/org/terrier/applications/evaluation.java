...
public static void readtrecmatches()
{
	...
	try {
		 excep=new BufferedWriter(new FileWriter(new File("/home/bhargava/Documents/afghanistan/excep")));
	...
	try {
		 run=new BufferedWriter(new FileWriter(new File("/home/bhargava/Documents/afghanistan/run.ssv")));
	} catch (IOException e1) {
		// TODO Auto-generated catch block
		e1.printStackTrace();
	}BufferedWriter matches=null;
	try {
		matches=new BufferedWriter(new FileWriter(new File("/home/bhargava/Documents/afghanistan/match.tsv")));
	} catch (IOException e1) {
		// TODO Auto-generated catch block
		e1.printStackTrace();
	}BufferedWriter updates=null;
	try {
		 updates=new BufferedWriter(new FileWriter(new File("/home/bhargava/Documents/afghanistan/update.tsv")));
	} catch (IOException e1) {
		// TODO Auto-generated catch block
		e1.printStackTrace();
	}
		String outfolderpath="/home/bhargava/Documents/afghanistan/afghanresults/";
		//read hour files generated by learning score sort multiavg
		File outfolder=new File("/home/bhargava/Documents/afghanistan/afghanresults/");
