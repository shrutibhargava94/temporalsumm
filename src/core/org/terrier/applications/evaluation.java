...
update_trec=new ArrayList<updateattributes>();
	try {
		 updatetrecread = new BufferedReader(new FileReader(new File("/home/bhargava/updates_sampled (4).tsv")));
...
public static void readtrecmatches()
{
	...
	match_trec=new ArrayList<matchattributes>();
		try {
			 matchtrecread = new BufferedReader(new FileReader(new File("/home/bhargava/matches (2).tsv")));
		} catch (FileNotFoundException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	try {
		 excep=new BufferedWriter(new FileWriter(new File("/home/bhargava/Documents/afghanistanfull/excep")));
	...
	try {
		 run=new BufferedWriter(new FileWriter(new File("/home/bhargava/Documents/afghanistanfull/run.ssv")));
	} catch (IOException e1) {
		// TODO Auto-generated catch block
		e1.printStackTrace();
	}BufferedWriter matches=null;
	try {
		matches=new BufferedWriter(new FileWriter(new File("/home/bhargava/Documents/afghanistanfull/match.tsv")));
	} catch (IOException e1) {
		// TODO Auto-generated catch block
		e1.printStackTrace();
	}BufferedWriter updates=null;
	try {
		 updates=new BufferedWriter(new FileWriter(new File("/home/bhargava/Documents/afghanistanfull/update.tsv")));
	} catch (IOException e1) {
		// TODO Auto-generated catch block
		e1.printStackTrace();
	}
		String outfolderpath="/home/bhargava/afghanresults/";
		//read hour files generated by learning score sort multiavg
		File outfolder=new File("/home/bhargava/afghanresults/");
